...
### Changed
- Bumped compileSdkVersion to API 36 (Android 16)
- Bumped targetSdkVersion to API 36 (Android 16)
- Bumped minSdkVersion to API 28 (Android 9)
- Rewrote some files from Java to Kotlin
- Updated dependencies
- Moved dependencies to libs.version.toml
- Updated README.md
...
- Fixed an issue with beacon entry and exit campaign triggers
- Fixed a crash that could occur during service outage

## [4.1.1][] - 2022-09-08

### Fixed

- Fixed an issue that prevented background beacon scanning
...
- Fixed beacon campaign triggers
- Fixed an issue where re-entering a geofence would fail to restart beacon scanning
...
[4.3.0]: https://github.com/phunware/maas-engagement-android-sdk/compare/4.2.0...4.3.0
[4.2.0]: https://github.com/phunware/maas-engagement-android-sdk/compare/4.1.2...4.2.0
[4.1.2]: https://github.com/phunware/maas-engagement-android-sdk/compare/4.1.1...4.1.2
[4.1.1]: https://github.com/phunware/maas-engagement-android-sdk/compare/4.1.0...4.1.1
[4.1.0]: https://github.com/phunware/maas-engagement-android-sdk/compare/4.0.2...4.1.0
[4.0.2]: https://github.com/phunware/maas-engagement-android-sdk/compare/4.0.1...4.0.2
